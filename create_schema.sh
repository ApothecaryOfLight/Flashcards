...
echo "CREATE TABLE first_level_subjects ( name VARCHAR(150) NOT NULL, first_level_subject_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY );" >> "create_schema.sql"
echo "CREATE TABLE second_level_subjects ( name VARCHAR(150) NOT NULL, second_level_subject_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, member_of_first_level_subject_id INT NOT NULL, FOREIGN KEY (member_of_first_level_subject_id) REFERENCES first_level_subjects(first_level_subject_id) );" >> "create_schema.sql"
echo "CREATE TABLE third_level_subjects ( name VARCHAR(150) NOT NULL, third_level_subject_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, member_of_second_level_subject_id INT NOT NULL, FOREIGN KEY (member_of_second_level_subject_id) REFERENCES second_level_subjects(second_level_subject_id) );" >> "create_schema.sql"
echo "CREATE TABLE fourth_level_subjects ( name VARCHAR(150) NOT NULL, fourth_level_subject_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, member_of_third_level_subject_id INT NOT NULL, FOREIGN KEY (member_of_third_level_subject_id) REFERENCES third_level_subjects(third_level_subject_id) );" >> "create_schema.sql"

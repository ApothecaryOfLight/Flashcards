...
echo "CREATE TABLE tags( name VARCHAR(150), set_id INT, FOREIGN KEY (set_id) REFERENCES sets(set_id), card_id INT, FOREIGN KEY (card_id) REFERENCES cards(card_id) );" >> "create_schema.sql"

echo "CREATE TABLE card_search_text( name VARCHAR(150), set_id INT, FOREIGN KEY (set_id) REFERENCES sets(set_id), card_id INT, FOREIGN KEY (card_id) REFERENCES cards(card_id) );" >> "create_schema.sql"
echo "CREATE TABLE card_search_topics( name VARCHAR(150), set_id INT, FOREIGN KEY (set_id) REFERENCES sets(set_id), card_id INT, FOREIGN KEY (card_id) REFERENCES cards(card_id) );" >> "create_schema.sql"
echo "CREATE TABLE cardset_search_text( name VARCHAR(150), set_id INT, FOREIGN KEY (set_id) REFERENCES sets(set_id), card_id INT, FOREIGN KEY (card_id) REFERENCES cards(card_id) );" >> "create_schema.sql"
echo "CREATE TABLE cardset_search_topics( name VARCHAR(150), set_id INT, FOREIGN KEY (set_id) REFERENCES sets(set_id), card_id INT, FOREIGN KEY (card_id) REFERENCES cards(card_id) );" >> "create_schema.sql"
